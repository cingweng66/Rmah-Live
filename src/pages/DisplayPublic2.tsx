...
import { DisplayView2 } from "@/components/game/DisplayView2";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "@/components/ui/card";

const DisplayPublic2 = () => {
  ...
  const handleConnect = () => {
    ...
    setError('');
    setIsConnected(true);
    navigate(`/display-public2?room=${trimmedGameId}`, { replace: true });
  };
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
        <Card className="w-full max-w-md">
          <CardHeader>
            ...
            <CardDescription>输入6位数字房间号以连接 broadcast（布局2）</CardDescription>
          </CardHeader>
  ...
  return <DisplayView2 gameId={gameId} readOnly={true} />;
};

export default DisplayPublic2;
